...
#### معايير القبول
- [ ] إضافة قناة للـ Watchlist يُراقبها يومياً
- [ ] إضافة keyword يُشغّل بحثاً يومياً
- [ ] فيديو جديد من قناة مراقبة → يُعالج تلقائياً
- [ ] نتائج تُخزّن في DB وتُرسل كإشعار (TASK-17)
